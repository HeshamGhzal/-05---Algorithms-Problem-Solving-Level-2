...
void copy_odd_numbers_from_array_to_another_dinamicaly(int arr1[], int arr2[], int size1, int& size2);
...
int main()
{
	...
	copy_odd_numbers_from_array_to_another_dinamicaly(arr1, arr2, size, size2);
